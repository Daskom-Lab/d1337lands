...
module.exports = {
  ...
  plugins: [
    ...
    new FaviconsWebpackPlugin({
      ...
      favicons: {
        appName: 'Daskom1337 Lands',
        appDescription: 'Daskom1337 Community RPG Game',
        developerName: 'Daskom1337 Community',
        developerURL: "https://github.com/Daskom-Lab", // prevent retrieving from the nearest package.json
        icons: {
          coast: false,
          yandex: false
        }
