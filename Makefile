...
migrate:
	cd database && hasura migrate apply --skip-update-check --database-name default && hasura seed apply --skip-update-check --database-name default && hasura metadata apply --skip-update-check && cd ..
